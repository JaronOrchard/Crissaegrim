...
public class Tile1RI extends Tile {
	
	public Tile1RI() {
		super(Textures.NONE, Textures.TILE_1RI, Textures.NONE);
	}
	
	public Tile1RI(int fgTexture, int mgTexture, int bgTexture) {
	...
	protected List<Line> getTileBoundaryLines(int xPos, int yPos) {
		return Arrays.asList(
				...
				new Line(new Coordinate(xPos + 1, yPos + 1), new Coordinate(xPos, yPos)),
